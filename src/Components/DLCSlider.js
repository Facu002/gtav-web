...
function DLCSlider() {
    ...
    return (
...

        {
            ...
            //             <img src={OnlineCrimEnterLogo} className="logo"/>
            //             <div className="promo-container"  style={{backgroundImage:`url(${OnlineCrimEnterBackground})`}}>
            //                 <div className="promo-container">
            //                 <img src={OnlineCrimEnterPromo} className='promo'/>
            //                 </div>
            //             </div>
            //         </div>
            ...
            //                 <h4 className='title'>{'The Criminal Enterprises'}</h4>
            //                 {/* {props.text} */}
